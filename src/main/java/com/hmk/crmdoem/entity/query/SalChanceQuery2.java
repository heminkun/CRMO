 ...
 * 
 */
public class SalChanceQuery2 extends BaseParam {
	...
	private Integer chcStatus2;

	private Integer chcStatus3;

	private Integer chcStatus4;

	public Integer getChcStatus2() {
		return chcStatus2;
	}

	public void setChcStatus2(Integer chcStatus2) {
		this.chcStatus2 = chcStatus2;
	}

	public Integer getChcStatus3() {
		return chcStatus3;
	}

	public void setChcStatus3(Integer chcStatus3) {
		this.chcStatus3 = chcStatus3;
	}

	public Integer getChcStatus4() {
		return chcStatus4;
	}

	public void setChcStatus4(Integer chcStatus4) {
		this.chcStatus4 = chcStatus4;
	}
